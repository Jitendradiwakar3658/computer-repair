...
class Sector126 extends React.Component{
    render() {
        return(
            <div>
                 <section id="services">
                    <div className="container"> <header className="section-header">
                        ...
                        <div className="row">
                            <div className="col-md-9">
                                ...
                                <p>The Dell Laptop Service Center in Noida Sector 2 provides the low cost service as well as on time
