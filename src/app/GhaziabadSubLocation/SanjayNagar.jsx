...
class SanjayNagar extends React.Component{
    render() {
        return(
            <div>
                 <section id="services">
                    <div className="container"> <header className="section-header">
                        <h3>Dell Laptop Service Center in Sanjay Nagar Ghaziabad</h3>
                        <div className="row">
                            <div className="col-md-9">
                                ...
                                <p>The Dell Laptop Service Center in Sanjay Nagar Ghaziabad provides the low cost service as well as on time
