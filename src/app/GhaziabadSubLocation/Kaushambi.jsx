...
class Kaushambi extends React.Component{
    render() {
        return(
            <div>
                 <section id="services">
                    <div className="container"> <header className="section-header">
                        <h3>Dell Laptop Service Center in Kaushambi Ghaziabad</h3>
                        <div className="row">
                            <div className="col-md-9">
                            <p>Have you got a problem or damage in your Dell laptop? Are you looking for an instant and affordable laptop solution? 
                                Your search end here. <b>Dell Laptop Service Center in Kaushambi Ghaziabad</b> offers reasonable and low-cost laptop repair solutions
                                ...
                                <b>Dell Laptop Repair Center in Kaushambi Ghaziabad</b>
                                ...
                                <br/><br/>
                                   ...
                                   <br/><br/><b>Hunting for Dell Laptop Service Center in Kaushambi Ghaziabad ? </b><br/><br/>
